...
async function main() {
  ...
  if (stack === 'mern') {
    ...
    const apiKey = await text({
      message: 'Paste your Dripmetric API Key:',
      placeholder: 'obf_...',
      validate: (value) => {
    ...
    const authTemplate = `
// auth.js - Generated by Dripmetric
const express = require('express');
const router = express.Router();

// You would run: npm install dripmetric
// const { Dripmetric } = require('dripmetric');
...
// CONFIG
const client = new Dripmetric("${apiKey}");
