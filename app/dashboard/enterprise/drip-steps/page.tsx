      ...
      <div className="min-h-screen bg-background p-8">
        <div className="max-w-2xl mx-auto flex flex-col gap-6">
          ...
          <div className="rounded-lg border border-border bg-card p-8 text-center flex flex-col gap-4">
            ...
            <h1 className="text-xl font-bold text-foreground">Unlimited Drip Steps — Growth Feature</h1>
            <p className="text-sm text-muted-foreground">
              Free plan supports 3 hardcoded steps. Upgrade to Growth for unlimited steps with full control.
            </p>
            <Link
